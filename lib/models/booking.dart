...
class Booking {
  ...
  Booking({
    ...
    DateTime? createdAt, // Make it optional with default value
           ...
           createdAt ?? DateTime.now(); // Set current time if not provided
  ...
  double get durationInHours {
    try {
      ...
      developer.log('Error parsing time for durationInHours: $e');
      return 0.0;
    }
  }
